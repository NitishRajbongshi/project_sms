...
<body id="body-pd">
    ...
    <div class="container py-2">
        <h3 class="text-primary mt-2 border-bottom border-2 border-primary py-2">Group Meeting</h3>
        <p class="text-secondary">Create a new group meeting to all the student associated with you.</p>
    </div>
